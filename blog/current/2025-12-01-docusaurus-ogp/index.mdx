---
title: Docusaurus で OGP 画像を設定する
authors: [bonychops]
tags: ["アドベントカレンダー", "Advent Calendar 2025", "Docusaurus", "OGP", "長野高専 Advent Calendar 2025"]
advent: 2025
---
...
:::info
こちらは[長野高専 Advent Calendar 2025](https://qiita.com/advent-calendar/2025/nnct) 1日目の記事です。
:::
...
![Advent Calendar 2025 | DocusaurusでOGP画像を設定する | BonyChops Blog と書かれた画像](./ogp.png)
...
![DocusaurusでOGP画像を設定する とだけ書かれた画像](./ogp2.png)
:::
...
<Tabs>
  <TabItem value="normal" label="通常" default>
    ![M1 Macで仮想Windowdを起動する | BonyChops Blog と書かれた画像](./ogp3.png)
  </TabItem>
